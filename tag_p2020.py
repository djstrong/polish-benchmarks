...
parser.add_argument('--years', action='store_true', help='add years as embeddings')
...
columns = {0: 'text', 1: 'space_before', 2: 'lemma', 3:'pos', 4:'tags', 5:'years'}
#sample 10% of train as dev
corpus: Corpus = TSVCorpus('datasets/pos_p2020/', columns,
                                    train_file='train.tsv',
                                    test_file='devel-disamb.tsv',
                                    dev_file=None)
tag_type = 'pos'
...
if args.pretrained_model is None:
    ...
    if args.years:
        embedding_types.append(OneHotEmbeddings(corpus=corpus, field='years', embedding_length=3))
